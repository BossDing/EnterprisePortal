			...
			<div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
				<div class="am-offcanvas-bar admin-offcanvas-bar">
					<ul class="am-list admin-sidebar-list">
						...
						<li>
							<a href="adminUser.mvc?userId=${user.userId}&start=0&number=5" title="管理员管理">
								...
								<tbody>
									...
									<c:forEach items="${userList}" var="user">
										<tr>
											...
											<td>${user.userName}</td>
											<td class="table-title">${user.userPwd}</td>
											<td class="table-title">${user.registerTime}</td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
